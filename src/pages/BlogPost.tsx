...
export const BlogPostPage: React.FC = () => {
  ...
  const getPostCategoryLabel = (id: string) => {
    if (id === 'b1') return language === 'ar' ? "دهانات وأصباغ" : "Paints & Coatings";
    if (id === 'b2') return language === 'ar' ? "ديكور وجبس" : "Gypsum & Decor";
  ...
  return (
    <>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-6 pb-12 space-y-6">
        ...
        <Link
          to="/blog"
          className="inline-flex items-center gap-2 text-xs font-mono font-bold text-amber-500 hover:text-amber-400"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-6">
          ...
          {/* Quick Consultation Sidebar CTA (Span 4) */}
          <aside className="lg:col-span-4">
            <div className="sticky top-28 p-6 rounded-2xl bg-neutral-900 border border-neutral-850 shadow-xl space-y-6 text-center">
              ...
              <div className="space-y-3 pt-2">
                <Link
                  to="/request-quote"
                  className="block w-full py-3 rounded-lg bg-gradient-to-r from-amber-500 to-yellow-600 text-neutral-950 font-extrabold text-xs shadow-md"
                >
                  {t.btn_request_quote}
                </Link>
                <a
                  ...
                  className="block w-full py-3 rounded-lg bg-neutral-950 border border-neutral-800 text-neutral-300 hover:text-amber-400 text-xs font-bold font-mono"
                >
                  {t.btn_chat_whatsapp}
                </a>
              </div>
