...
import { HelpCircle, ChevronDown, Search, MessageSquareCode } from 'lucide-react';
        ...
        {filteredFaqs.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredFaqs.map((faq, idx) => {
              ...
              return (
                <div key={faq.id} className="rounded-xl bg-neutral-900 border border-neutral-850 overflow-hidden shadow-sm hover:border-amber-500/15 transition-all">
                  <button
      ...
      <section className="py-12 bg-neutral-900 border-t border-neutral-900 text-center">
        <div className="max-w-2xl mx-auto px-4 space-y-3">
          ...
          <div className="pt-2 flex items-center justify-center gap-4 flex-wrap">
            <Link to="/request-quote" className="px-5 py-2.5 rounded bg-gradient-to-r from-amber-500 to-yellow-600 text-neutral-950 text-xs font-bold">
              {t.btn_request_quote}
            </Link>
            <a
